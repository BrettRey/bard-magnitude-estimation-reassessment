...
- Genre lane (Brett, 2026-06-23): HOLD the hybrid (design + synthesis) as the working draft; defer the Registered-Report-vs-theory-note choice until Sprouse replies about data reuse. Reason: permission is pending, not denied, and the reply determines what is feasible. Do not submit in the hybrid state, but it is a fine holding pattern. Revisit the genre decision when Sprouse answers.
