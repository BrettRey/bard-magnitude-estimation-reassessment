...
not. The single-dimension assumption is tested before any method-specific term
is read, by comparing a one-factor model against correlated-two-factor and
bifactor alternatives and checking method residuals for item-level structure.
...
response functions and the dimensionality gate let a resolution advantage
