...
bounded methods share a strong aggregate item-level signal. Raw Likert means
...
but the endpoint and pair-level diagnostics do not show a systematic practical
...
response-function, and pair-robustness scripts. The reported \(n\) values are
aggregate condition, item, or pair units, not participant-level rows.
