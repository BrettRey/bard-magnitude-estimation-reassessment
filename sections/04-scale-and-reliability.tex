...
.97], 2017 items [.92, .93], and 2017 pairs [.92, .96], and pair-level
...
\midrule
ME--Likert convergence & Conditions \(n=298\), \(r=.99\); pairs \(n=150\), \(r=.96\) & Items \(n=786\), \(r=.92\); pairs \(n=50\), \(r=.94\) \\ \addlinespace[2pt]
...
Bounded response function & Conditions \(n=298\): bounded logistic improves over linear; endpoint ME SDs .14 and .17 versus middle .31 & Items \(n=786\): bounded logistic improves over linear; endpoint ME SDs .25 and .32 versus middle .35 \\ \addlinespace[2pt]
...
of forced choice (\deltaRsq{} = .02--.05); the increment doesn't generalize
