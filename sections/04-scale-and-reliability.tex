...
correlations remain high for 2013 conditions [.98, .99], 2013 pairs [.95,
.97], 2017 items [.92, .93], and 2017 pairs [.92, .97], and pair-level
bounded-predictor \Rsq{} remains high for 2013 [.90, .95] and 2017
[.86, .94].
...
\midrule
ME--Likert convergence & Conditions \(n=298\), \(r=.99\); pairs \(n=150\), \(r=.96\) & Items \(n=786\), \(r=.93\); pairs \(n=50\), \(r=.94\) \\ \addlinespace[2pt]
...
Bounded response function & Conditions \(n=298\): bounded logistic improves over linear; endpoint ME SDs .14 and .18 versus middle .31 & Items \(n=786\): bounded logistic improves over linear; endpoint ME SDs .25 and .32 versus middle .35 \\ \addlinespace[2pt]
Pair robustness & Pairs \(n=150\): bounded predictors \Rsq{} = .93; no ME top-quartile pair falls in the bounded bottom half & Pairs \(n=50\): bounded predictors \Rsq{} = .90; no ME top-quartile pair falls in the bounded bottom half \\
\bottomrule
\end{tabular}
...
of forced choice (\deltaRsq{} = .03--.05); the increment doesn't generalize
