...
The contribution is therefore the routing. Existing method-comparison work
already weakens magnitude estimation's special status; this paper asks what the
surviving formal-judgment signal licenses us to project. In the approved
Sprouse reanalysis, formal judgment formats preserve stable item-level contrast
ordering across the tested contrasts, while magnitude estimation adds no
separate practical ordering there.
